package com.example.hiringcandidateservice.config;
...
public class SpringFoxConfig implements WebMvcConfigurer {
    ...
    public Docket api() {
        return new Docket(DocumentationType.SWAGGER_2)
                ...
                .select()
                .apis(RequestHandlerSelectors.basePackage("com.example.hiringcandidateservice.controller"))
                .paths(PathSelectors.any())
                .build()
                .apiInfo(apiInfo());
    }
    ...
    private ApiInfo apiInfo() {
        return new ApiInfo("LMS",
                ...
                "1.0",
                "Terms of service",
                new Contact("LMS", "http://bridgelabz.lms", "svarma852@gmail.com"),
                "Apache 2.0",
